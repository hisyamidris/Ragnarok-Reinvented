...
struct mmo_account
{
	...
	char mac[18];				// save of last MAC of connection
	char cpu_id[37];			// save of last cpu ID of connection
	char drive_id[9];			// save of last disk drive ID of connection
	char motherboard_id[20];	// save of last motherboard ID of connection
};
